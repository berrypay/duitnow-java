...
public class RppProxyStatusCode {
    private RppProxyStatusCode() {
    }

    // Source: https://docs.developer.paynet.my/docs/dobw/mapping-tables#proxy-status-code
    public static final String ACCEPTED = "ACTC";
