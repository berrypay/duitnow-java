...
public class RppReasonCode {
    ...
    public static final String INVALID_SOURCE_OF_FUND = "U301";
    public static final String INVALID_QR_RESPONSE = "U304";
    public static final String BIZMSGID_CREDTTM_DATE_UNMATCHED = "U305";
    public static final String INVALID_SECONDARY_ID = "U306";
    public static final String QR_CATEGORY_TXN_TYPE_UNMATCHED = "U307";
    public static final String RFP_EXPIRED = "U310";
    public static final String RFP_ALREADY_TRANSFERRED = "U311";
    public static final String RFP_NOT_FOUND = "U312";
    public static final String RFP_ALREADY_PROCESSED = "U313";
    public static final String RFP_ALREADY_REJECTED = "U314";
    public static final String RFP_INVALID_STATE = "U315";
    public static final String RFP_ALREADY_RECEIVED = "U316";
    public static final String RFP_INVALID_DEBTOR_AGENT = "U317";
    public static final String EXPIRY_DATE_EARLIER_THAN_CURRENT = "U318";
    public static final String EXPIRY_DATE_FORMAT_ERROR = "U319";
    public static final String REQUESTED_EXECUTION_DATE_EARLIER_THAN_CURRENT = "U320";
    public static final String REQUESTED_EXECUTION_DATE_FORMAT_ERROR = "U321";
    public static final String REQUESTED_MANDATE_INACTIVE = "U322";
    public static final String INVALID_DEBTOR_AGENT = "U323";
    public static final String INVALID_ORIGINAL_DEBTOR_AGENT = "U324";
    public static final String MANDATE_ALREADY_TRANSFERRED = "U325";
    public static final String RFP_ALREADY_ACCEPTED = "U326";
    public static final String MERCHANT_INACTIVE = "U327";
    public static final String MERCHANT_PRODUCT_NOT_FOUND = "U328"; // Biller code not found
    public static final String MERCHANT_NOT_FOUND = "U329";
    public static final String MERCHANT_PARAMETER_NOT_FOUND = "U330";
    public static final String MERCHANT_MIN_AMOUNT_CHECK_FAILED = "U331";
    public static final String MERCHANT_MAX_AMOUNT_CHECK_FAILED = "U332";
    public static final String EXPIRY_DATE_CHECK_FAILED = "U333";
    public static final String MANDATE_IS_NOT_PENDING = "U334";
    public static final String RFP_LOOKUP_RULES_NOT_FOUND = "U335";
    public static final String PRE_AUTH_EXPIRY_DATE_FORMAT_ERROR = "U336";
    public static final String PRE_AUTH_EXPIRY_EXCEED_MANDATE_EXPIRY = "U337";
    public static final String PRE_AUTH_EXPIRY_EARLIER_THAN_CREDTTM = "U338";
    public static final String PRE_AUTH_EXPIRY_DATE_EARLIER_THAN_CURRENT = "U339";
    public static final String MERCHANT_PRODUCT_INACTIVE = "U340";
    public static final String MERCHANT_VALIDATION_RULE_NOT_FOUND = "U341";
    public static final String MERCHANT_PRODUCT_BANK_CODE_NOT_FOUND = "U342";
    public static final String MANDATE_UPDATE_IN_PROGRESS = "U343";
    public static final String DD_PARTICIPANTS_CHECKS_FAILED = "U344";
    public static final String CANNOT_UPDATE_REJECTED_MANDATE = "U345";
    public static final String CANNOT_AUTHORISE_REJECTED_MANDATE = "U346";
    public static final String RFP_PENDING_AUTHORISATION = "U347";
    public static final String CREDITOR_BANK_ACCOUNT_DETAILS_MISSING = "U348";
    public static final String ALIAS_MANAGEMENT_ACTION_NOT_CONFIGURED = "U800";
    public static final String ALIAS_RULE_NOT_FOUND = "U801";
    public static final String ADDRESSING_PRIVILEGE_NOT_DEFINED = "U802";
    public static final String ADDRESSING_ACTION_INSUFFICIENT_PRIVILEGE = "U803";
    public static final String ALIAS_NOT_FOUND = "U804";
    public static final String ALIAS_SUSPENDED = "U805";
    public static final String ALIAS_ALREADY_REGISTERED_SAME_FI_DIFF_ACCOUNT = "U806";
    public static final String ALIAS_ALREADY_REGISTERED_OTHER_FI = "U807";
    public static final String ALIAS_ALREADY_REGISTERED_SAME_ACCOUNT = "U808";
    public static final String ALIAS_ADDRESSING_ACTION_INSUFFICIENT_PRIVILEGE = "U809";
    public static final String ALIAS_REQUEST_FAILED = "U810";
    public static final String ALIAS_SUSPENDED_BY_ADMIN = "U811";
    public static final String ALIAS_DESTINATION_NOT_CONFIGURED = "U812";
    public static final String ALIAS_CACHE_MAINTENANCE_FAILED = "U813";
    public static final String ALIAS_ALREADY_REGISTERED_SAME_FI = "U814";
    public static final String DUPLICATE_ALIAS_SERVICE_REQUEST = "U815";
    public static final String DUPLICATE_ALIAS_SERVICE_REQUEST_DETECTED = "U816";
    public static final String SYS_NOTIFY_EVENT_CODE_OR_RULES_NOT_FOUND = "U850";
    public static final String GENERAL_PURPOSE_RULES_NOT_FOUND = "U851";
    public static final String INVALID_BUSINESS_HIERARCHY = "U890";
    public static final String INTERNAL_TIMEOUT = "U900";
    public static final String SYS_MALFUNCTION = "U901";
    public static final String CON_COMM_ERROR = "U902";
    public static final String SCRIPTING_ERROR = "U903";
    public static final String ENDPOINT_ERROR = "U904";
    public static final String CONFIG_ERROR = "U905";
    public static final String LOGGING_OR_DB_ERROR = "U906";
    public static final String SESSION_ERROR_NO_PLAN_EXECUTED = "U907";
    public static final String VALIDATION_ERROR = "U908";
    public static final String RESPONSE_CODE_AVAILABLE = "U909";
    public static final String NO_SESSION_RESPONSE_WITHIN_TIMEOUT = "U910";
    public static final String NO_SUCH_SESSION = "U911";
    public static final String SESSION_VALIDATION_ERROR = "U912";
    public static final String NO_SESSION_REQUEST_VARIABLE = "U913";
    public static final String SESSION_ERROR_TIMEOUT = "U990";
    public static final String RESPONSE_NOT_DELIVERED = "U992";
    public static final String REASON_CODE_NOT_DETERMINED_IN_RESPONSE = "U993";
    public static final String REQUEST_SIGNATURE_VALIDATION_FAILED = "U999";
    public static final String INVALID_FOREX_RATE = "P001";
    public static final String SETTLEMENT_AMOUNT_UNMATCHED_FIELD3 = "P002";
    public static final String NON_BANK_PARTICIPANT_NOT_ALLOWED = "P003";
    public static final String DUPLICATE_FOREX_RECORD = "P004";
    public static final String INVALID_FOREX_RECORD = "P005";
    public static final String FOREX_RATE_EXPIRED = "P006";
    public static final String FIELD3_INTRBKSTTLMAMT_NOT_MATCHED = "P007";
    public static final String PREAUTH_AMOUNT_EXCEED_LIMIT = "P008";
    public static final String PREAUTH_LIMIT_NOT_CONFIGURED = "P009";
    public static final String INVALID_REF1 = "P010";
    public static final String FOREX_SESSION_ERROR_TIMEOUT = "P990";
}
